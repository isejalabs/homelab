...
- If a hook surfaces a learning, past bug, or repeat-read warning, treat it as relevant context and verify it against repository truth when it affects a decision or change.
