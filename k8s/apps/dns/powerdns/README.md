...
This key also needs configuring on `10.7.2.12` itself (outside this repo) once it's actually set up to slave the zone — not something this repo's manifests can do.
