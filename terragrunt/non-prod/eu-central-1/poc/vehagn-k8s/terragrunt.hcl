...
terraform {
  ...
  source = "git::https://github.com/isejalabs/terraform-proxmox-talos.git?ref=v7.2.3"
}
...
inputs = {
  ...
  image = {
    version        = "v1.12.11"
    update_version = "v1.12.12" # renovate: github-releases=siderolabs/talos
  ...
  cluster = {
    ...
    kubernetes_version           = "v1.34.11" # renovate: github-releases=kubernetes/kubernetes
    kubelet                      = <<-EOT
      extraArgs:
    ...
    talos_machine_config_version = "v1.12.12" # renovate: github-releases=siderolabs/talos
    vip                          = "10.7.8.160"
  }
