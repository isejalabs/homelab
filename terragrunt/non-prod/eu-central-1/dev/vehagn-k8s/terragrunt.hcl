...
terraform {
  ...
  source = "git::git@github.com:isejalabs/terraform-proxmox-talos.git?ref=v6.0.2"
}
...
inputs = {
  ...
  cluster = {
    ...
    talos_machine_config_version = "v1.11.6" # renovate: github-releases=siderolabs/talos
    vip                          = "10.7.8.130"
  }
