...
locals {
  ...
  # base_source_url = "git::https://github.com/cisagov/terraform-state-read-role-tf-module.git"
  # Pin module version to a specific tag to ensure consistency across environments (and to ease renovate's job).
  base_source_url = "git::https://github.com/cisagov/terraform-state-read-role-tf-module.git?ref=v1.0.0"
