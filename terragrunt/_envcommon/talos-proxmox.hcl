...
locals {
  ...
  # in the merge below). Shape matches the `proxmox` variable of terraform-modules//modules/talos-proxmox
  # (base_source_url below).
  secret_defaults = {
    proxmox = {
      name         = "ci-placeholder"
  ...
  base_source_url = "git::https://github.com/isejalabs/terraform-modules.git//modules/talos-proxmox"
}
